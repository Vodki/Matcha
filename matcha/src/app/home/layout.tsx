          ...
          <div className="navbar-start">
            ...
            >
              <Image
                ...
                width={28}
                height={28}
                className="w-7 h-7 group-hover:scale-110 transition-transform -translate-y-1"
              />
              <span className="text-2xl font-black leading-none bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent group-hover:scale-105 transition-transform">
                Matcha
              </span>
            </Link>
          </div>
