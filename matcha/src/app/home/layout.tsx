...
export default function RootLayout({
  ...
  return (
    <ProtectedRoute>
      <section className="w-full min-h-screen pt-16 bg-gradient-valentine">
        <div className="fixed inset-x-0 top-0 z-50 navbar glass shadow-lg border-b border-white/20">
          <div className="navbar-start">
            <div className="dropdown dropdown-start text-sm">
              <div
                tabIndex={0}
                role="button"
                className="btn btn-ghost btn-circle indicator hover:bg-primary/10 transition-colors"
              >
                {hasUnreadNotifications && (
                  <span className="indicator-item badge badge-secondary badge-xs animate-pulse"></span>
                )}
                <svg
